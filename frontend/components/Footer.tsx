      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/category/electronics" className="text-gray-400 hover:text-white transition text-sm">
                  Electronics
                </Link>
              </li>
              <li>
                <Link href="/category/vehicles" className="text-gray-400 hover:text-white transition text-sm">
                  Vehicles
                </Link>
              </li>
              <li>
                <Link href="/category/jewelry" className="text-gray-400 hover:text-white transition text-sm">
                  Jewelry & Watches
                </Link>
              </li>
              <li>
                <Link href="/category/home-garden" className="text-gray-400 hover:text-white transition text-sm">
                  Home & Garden
                </Link>
              </li>
              <li>
                <Link href="/category/art-collectibles" className="text-gray-400 hover:text-white transition text-sm">
                  Art & Collectibles
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 Ethiopian Auction. All rights reserved.
          </p>
