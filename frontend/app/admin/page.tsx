            ...
            <nav className="space-y-1">
              {sidebarItems.map((item) => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition ${activeTab === item.id
                ...
                <div className="p-8">
                  ...
                  <div className="flex items-center gap-3 mb-6 flex-wrap">
                    <button
                      ...
                      className={`px-4 py-2 rounded-full font-medium transition flex items-center gap-2 ${userFilter === 'all'
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-full font-medium transition flex items-center gap-2 ${userFilter === 'buyers'
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-full font-medium transition flex items-center gap-2 ${userFilter === 'sellers'
                    ...
                    <button
                      ...
                      className={`px-4 py-2 rounded-full font-medium transition flex items-center gap-2 ${userFilter === 'admins'
                        ...
                        {filteredClients.length === 0 ? (
                          ...
                          <div key={client.id} className="grid grid-cols-12 gap-4 py-4 items-center hover:bg-gray-50 transition group cursor-pointer">
                            ...
                            <div className="col-span-3 flex items-center gap-3">
                              <div className="relative">
                                <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white text-lg font-bold ${client.role === 'admin' ? 'bg-gradient-to-br from-orange-400 to-red-500' :
                            ...
                            <div className="col-span-1">
                              <span className={`px-2 py-1 rounded-full text-xs font-bold whitespace-nowrap ${client.role === 'admin' ? 'bg-gradient-to-r from-orange-500 to-red-500 text-white' :
                            ...
                            <div className="col-span-2">
                              {(() => {
                                ...
                                return (
                                  <span className={`px-3 py-1 rounded-full text-xs font-medium ${isBlacklisted ? 'bg-red-50 text-red-600 border border-red-200' :
                      ...
                      <div className="divide-y divide-gray-100">
                        {realAuctions.map((auction: any) => (
                          <div key={auction.id} className="grid grid-cols-12 gap-4 py-4 items-center hover:bg-gray-50 transition">
                            ...
                            <div className="col-span-2">
                              <span className={`px-3 py-1 rounded-full text-xs font-medium ${auction.status === 'active' ? 'bg-green-50 text-green-600 border border-green-200' :
                        ...
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <span className={`px-3 py-1 rounded-full text-xs font-medium ${dispute.priority === 'high' ? 'bg-red-50 text-red-600 border border-red-200' :
                                dispute.priority === 'medium' ? 'bg-orange-50 text-orange-600 border border-orange-200' :
                                  'bg-gray-50 text-gray-600 border border-gray-200'
                                }`}>
                                {dispute.priority} priority
                              </span>
                              <span className={`px-3 py-1 rounded-full text-xs font-medium ${dispute.status === 'pending' ? 'bg-orange-50 text-orange-600 border border-orange-200' :
                    ...
                    {realReports.map((issue: any) => (
                      <div key={issue.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition">
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              <span className={`px-3 py-1 rounded-full text-xs font-medium ${issue.type === 'Fraud' ? 'bg-red-50 text-red-600 border border-red-200' :
                                issue.type === 'Spam' ? 'bg-orange-50 text-orange-600 border border-orange-200' :
                                  'bg-yellow-50 text-yellow-600 border border-yellow-200'
                                }`}>
                                {issue.type}
                              </span>
                              <span className={`px-3 py-1 rounded-full text-xs font-medium ${issue.severity === 'critical' ? 'bg-red-50 text-red-600 border border-red-200' :
                                issue.severity === 'high' ? 'bg-orange-50 text-orange-600 border border-orange-200' :
                                  'bg-gray-50 text-gray-600 border border-gray-200'
                                }`}>
                                {issue.severity}
                              </span>
                              <span className={`px-3 py-1 rounded-full text-xs font-medium ${issue.status === 'open' ? 'bg-orange-50 text-orange-600 border border-orange-200' :
                    ...
                    {realTransactions.length === 0 ? (
                      ...
                      return (
                        <div key={transaction.id} className="grid grid-cols-12 gap-4 py-4 items-center hover:bg-gray-50 transition">
                          ...
                          <div className="col-span-2">
                            <span className={`px-3 py-1 rounded-full text-xs font-medium ${transaction.status === 'in-escrow' ? 'bg-blue-50 text-blue-600 border border-blue-200' :
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <div className="flex items-center gap-3 mb-2">
                                ...
                                <span className={`px-3 py-1 rounded-full text-xs font-medium ${seller.status === 'pending' ? 'bg-orange-50 text-orange-600 border border-orange-200' :
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <div className="flex items-center gap-3 mb-1">
                                ...
                                <span className={`px-2 py-0.5 rounded-full text-xs font-bold uppercase ${log.risk_level === 'critical' ? 'bg-red-600 text-white' :
